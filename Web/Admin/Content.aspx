...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetSiteContent" TypeName="Pers.Domain.SiteContentManager" UpdateMethod="EditSiteContent">
        <UpdateParameters>
            <asp:Parameter Name="textId" Type="Int32" />
            <asp:Parameter Name="homepageWelcome" Type="String" />
            <asp:Parameter Name="homepageWhatsNew" Type="String" />
            <asp:Parameter Name="homepageWhatsUpLately" Type="String" />
        </UpdateParameters>
    </asp:ObjectDataSource>
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="TextId" DataSourceID="ObjectDataSource1">
        <EditItemTemplate>
            <p><b>TextId:</b>
                <asp:Label ID="TextIdLabel1" runat="server" Text='<%# Eval("TextId") %>'></asp:Label></p>
            <p><b>Homepage_Welcome:</b><br />
                <asp:TextBox ID="Homepage_WelcomeTextBox" runat="server" Text='<%# Bind("HomepageWelcome") %>' TextMode="MultiLine"> </asp:TextBox></p>
            <p><b>Homepage_WhatsNew:</b><br />
                <asp:TextBox ID="Homepage_WhatsNewTextBox" runat="server" Text='<%# Bind("HomepageWhatsNew") %>' TextMode="MultiLine"> </asp:TextBox></p>
            <p>
                <b>Homepage_WhatsUpLately:</b><br />
                <asp:TextBox ID="Homepage_WhatsUpLatelyTextBox" runat="server" Text='<%# Bind("HomepageWhatsUpLately") %>' TextMode="MultiLine">
                </asp:TextBox>
            </p>
            <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" Text="Update"> </asp:LinkButton>
            <asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel"> </asp:LinkButton>
        ...
        <ItemTemplate>
            <p><b>TextId:</b>
                <asp:Label ID="TextIdLabel" runat="server" Text='<%# Eval("TextId") %>'></asp:Label></p>
            <p><b>Homepage_Welcome:</b><br />
                <asp:Label ID="Homepage_WelcomeLabel" runat="server" Text='<%# Bind("HomepageWelcome") %>'> </asp:Label></p>
            <p><b>Homepage_WhatsNew:</b><br />
                <asp:Label ID="Homepage_WhatsNewLabel" runat="server" Text='<%# Bind("HomepageWhatsNew") %>'> </asp:Label></p>
            <p><b>Homepage_WhatsUpLately:</b><br />
                <asp:Label ID="Homepage_WhatsUpLatelyLabel" runat="server" Text='<%# Bind("HomepageWhatsUpLately") %>'> </asp:Label></p>
            <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit"> </asp:LinkButton>
        </ItemTemplate>
    </asp:FormView>
</asp:Content>
